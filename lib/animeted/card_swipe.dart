...
class CardSwipeA extends StatefulWidget {
  const CardSwipeA({super.key});

  @override
  State<CardSwipeA> createState() => _CardSwipeAState();
}

class _CardSwipeAState extends State<CardSwipeA> {
